...
<!-- # plotly API -->
<!-- Sys.setenv("plotly_username"="davistvan") -->
<!-- Sys.setenv("plotly_api_key"="i00mBUwOUdfbYbSLTIiU") -->
...
<!-- ```{r, out.width = "1200px"} -->
<!-- knitr::include_graphics("C:\\Users\\blast\\Documents\\GitHub\\stat297hw2\\line3d-basic.jpeg") -->
<!-- ``` -->
